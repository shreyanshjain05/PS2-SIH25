          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 bg-slate-900/40 backdrop-blur-md border border-slate-800 p-8 rounded-2xl relative overflow-hidden">
            ...
            <div className="flex items-center gap-6 border-b md:border-b-0 md:border-r border-slate-800 pb-6 md:pb-0 md:pr-10 w-full md:w-auto relative z-10">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-1.5">
                  ...
                  <span className="text-xs font-mono text-green-400 uppercase tracking-widest font-semibold">
                    Operational
                  </span>
                </div>
              </div>
            ...
            <div className="grid grid-cols-3 gap-6 md:gap-16 flex-grow w-full md:w-auto relative z-10">
              <div className="flex flex-col">
                <span className="text-[10px] text-slate-500 uppercase tracking-widest font-bold mb-2">
                  Model Confidence
                </span>
                <div className="flex items-end gap-3">
                  ...
                  <div className="mb-1.5 text-[10px] px-1.5 py-0.5 bg-teal-500/10 text-teal-400 rounded border border-teal-500/20">
                    +0.2%
                  </div>
                </div>
              </div>
            ...
            <div className="hidden lg:flex flex-col items-end gap-3 w-full md:w-auto pl-8 border-l border-slate-800 relative z-10">
              ...
              <div className="flex -space-x-3">
                <div
                  className="w-9 h-9 rounded-full bg-slate-800 border-2 border-slate-900 flex items-center justify-center text-[10px] font-bold text-slate-300 shadow-sm z-30"
                  title="CPCB"
                >
                  CP
                </div>
                <div
                  className="w-9 h-9 rounded-full bg-slate-800 border-2 border-slate-900 flex items-center justify-center text-[10px] font-bold text-slate-300 shadow-sm z-20"
                  title="IMD"
                >
                  IMD
                </div>
                <div
                  className="w-9 h-9 rounded-full bg-slate-800 border-2 border-slate-900 flex items-center justify-center text-[10px] font-bold text-slate-300 shadow-sm z-10"
                  title="ISRO"
                >
                  IS
                </div>
...
export const HowItWorks: React.FC = () => {
  return (
    <Section className="bg-slate-50 py-24 border-y border-slate-200 relative overflow-hidden">
      ...
      <svg
        className="absolute inset-0 w-full h-full opacity-[0.8] pointer-events-none"
        ...
        <FadeIn>
          <div className="flex flex-col md:flex-row justify-between items-end mb-16">
            <div className="max-w-xl">
              <div className="text-teal-600 font-mono text-xs tracking-widest uppercase mb-3 font-bold">
            ...
            {[
              {
                ...
                extra:
                  "Raw multispectral readings are captured from orbit and merged with CPCB/IMD sensor grids.",
                extra2:
                  "Data is pre-cleaned for cloud interference, noise, and missing streams before ingestion.",
                step: "01",
              },
              {
                title: "Processing",
                ...
                extra:
                  "Multiple AI pipelines—neural nets, physics-based dispersion models, and statistical ensembles—run in parallel.",
                extra2:
                  "Feature engineering extracts precursor signals like NO₂ plumes, humidity shifts, and photochemical intensity.",
                step: "02",
              },
              {
                title: "Prediction",
                ...
                extra:
                  "Time-series fusion predicts pollutant movement, chemical reactions, and hotspot formation.",
                extra2:
                  "Confidence intervals are computed to flag areas with high uncertainty or atypical atmospheric behavior.",
                step: "03",
              },
              {
                title: "Delivery",
                ...
                extra:
                  "Validated results are streamed through secured APIs to ministry dashboards & local authorities.",
                extra2:
                  "High-risk districts auto-trigger alerts, SMS advisories, and integration with public health systems.",
                step: "04",
              },
            ].map((item, i) => (
              <FadeIn
                key={i}
                delay={i * 100}
                className="relative pt-4 md:pt-8 group"
              >
    ...
    <div className="bg-slate-50 border-b border-slate-200 py-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-16 opacity-60 hover:opacity-100 transition-opacity duration-500">
          <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest border border-slate-200 px-2 py-1 rounded bg-white">
            Built With
          </span>
          ...
          <div className="lg:col-span-4 sticky top-32">
            <FadeIn>
              ...
              <p className="text-lg text-slate-600 font-light mb-8 leading-relaxed">
                Moving beyond simple PM2.5 monitoring. NAQFM leverages
                hyperspectral satellite data to detect gaseous precursors before
                they become hazardous smog.
              </p>
              <div className="p-6 bg-white rounded-2xl border border-slate-200 shadow-sm">
                ...
                <p className="text-sm text-slate-500 leading-relaxed">
                  O₃ and NO₂ are primary triggers for respiratory inflammation
                  and crop yield reduction, costing India approx 1.4% of GDP
                  annually.
                </p>
              </div>
            </FadeIn>
              ...
              <div className="h-full p-8 rounded-2xl border border-slate-200 bg-white shadow-sm hover:shadow-xl hover:border-blue-200 transition-all duration-300 group relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="flex justify-between items-start mb-6">
                    ...
                    <span className="text-4xl font-black text-slate-100 group-hover:text-blue-50 transition-colors font-mono">
                      O₃
                    </span>
                  </div>
                  ...
                  <p className="text-slate-600 mb-6 leading-relaxed text-sm">
                    A secondary pollutant formed by sunlight-driven reactions
                    between NOx and VOCs. Peaks in afternoons, causing invisible
                    lung damage.
                  </p>

                  <div className="flex flex-wrap gap-2">
                    <span className="px-2 py-1 bg-slate-50 border border-slate-100 rounded text-[10px] font-bold text-slate-500 uppercase">
              ...
              <div className="h-full p-8 rounded-2xl border border-slate-200 bg-white shadow-sm hover:shadow-xl hover:border-purple-200 transition-all duration-300 group relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="flex justify-between items-start mb-6">
                    ...
                    <span className="text-4xl font-black text-slate-100 group-hover:text-purple-50 transition-colors font-mono">
                      NO₂
                    </span>
                  </div>
                  ...
                  <p className="text-slate-600 mb-6 leading-relaxed text-sm">
                    A byproduct of high-temperature combustion in vehicles and
                    power plants. A key precursor to PM2.5 and acid rain.
                  </p>
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          <FadeIn>
            ...
            <p className="text-slate-400 text-lg font-light">
              One underlying AI model, four specialized interfaces. Ensuring
              seamless data flow from satellite sensors to street-level action.
            </p>
          </FadeIn>
        </div>
          ...
          {roles.map((role, idx) => (
            <FadeIn key={idx} delay={idx * 100}>
              <div className="group relative bg-slate-900 border border-slate-800 rounded-2xl p-6 hover:border-teal-500/50 transition-all duration-300 hover:-translate-y-2 hover:shadow-lg hover:shadow-teal-900/10 h-full flex flex-col z-10">
                <div
                  className={`absolute top-0 left-0 w-full h-1 bg-${role.color}-500 rounded-t-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
                ></div>

                <div className="flex justify-between items-start mb-6">
                  <div
                    className={`w-12 h-12 rounded-xl bg-slate-800 border border-slate-700 flex items-center justify-center text-${role.color}-400 group-hover:bg-${role.color}-600 group-hover:text-white group-hover:border-${role.color}-500 transition-all duration-300`}
                  >
                    <role.icon className="w-6 h-6" />
                  </div>
                  <span className="text-[10px] font-bold uppercase tracking-wider text-slate-400 bg-slate-800 px-2 py-1 rounded border border-slate-700">
                    {role.tag}
                  </span>
                </div>
    ...
    <Section className="bg-slate-50 py-24 border-y border-slate-200 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <FadeIn>
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="text-lg text-slate-600 font-light">
              How NAQFM translates raw satellite data into preemptive government
              action.
            </p>
          </div>
        </FadeIn>
        ...
        <div className="relative grid md:grid-cols-3 gap-8 md:gap-12">
          ...
          <FadeIn
            delay={100}
            className="relative bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl border border-slate-200 hover:border-teal-200 flex flex-col items-center text-center group hover:-translate-y-2 transition-all duration-300"
          >
            ...
            <div className="text-xs font-bold text-teal-600 uppercase tracking-wider mb-4 bg-teal-50 px-2 py-1 rounded">
              T-48 Hours
            </div>
            <p className="text-slate-600 text-sm leading-relaxed">
              Generates automated alerts 2 days in advance. Allows cities to
              implement GRAP measures (halting construction, diverting traffic)
              before pollution peaks.
            </p>
          </FadeIn>

          <FadeIn
            delay={200}
            className="relative bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl border border-slate-200 hover:border-blue-200 flex flex-col items-center text-center group hover:-translate-y-2 transition-all duration-300"
          >
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-2">
              Source Driver Intelligence
            </h3>
            <div className="text-xs font-bold text-blue-600 uppercase tracking-wider mb-4 bg-blue-50 px-2 py-1 rounded">
              Causal Impact Engine
            </div>
            <p className="text-slate-600 text-sm leading-relaxed">
              Identifies the dominant factors behind upcoming pollution spikes such as NO₂ plumes, stagnant wind fields, or photochemical
              build-up enabling officials to act on the true root cause rather
              than the symptoms.{" "}
            </p>
          </FadeIn>
          ...
          <FadeIn
            delay={300}
            className="relative bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl border border-slate-200 hover:border-indigo-200 flex flex-col items-center text-center group hover:-translate-y-2 transition-all duration-300"
          >
            ...
            <div className="text-xs font-bold text-indigo-600 uppercase tracking-wider mb-4 bg-indigo-50 px-2 py-1 rounded">
              Multi-Channel API
            </div>
            <p className="text-slate-600 text-sm leading-relaxed">
              Instantly pushes validated data to public billboards, hospital
              networks, and media outlets to minimize public exposure risks.
            </p>
          </FadeIn>
        </div>
      </div>
