  ...
  return (
    <header 
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled ? 'bg-white/95 backdrop-blur-md shadow-sm border-b border-slate-200/50' : 'bg-white/50 backdrop-blur-sm border-b border-white/10'
      }`}
    >
      {/* Top Strip */}
      <div className="bg-slate-950 text-slate-400 text-[10px] md:text-xs py-2 px-4 md:px-8 flex justify-between items-center tracking-wide relative z-50">
        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center gap-4">
            <div className="flex flex-col items-center justify-center pr-4 border-r border-slate-200">
               {/* Simplified Ashoka Chakra / Gov Emblem placeholder */}
               <div className="w-8 h-8 flex items-center justify-center group cursor-pointer">
                  <div className="w-6 h-6 rounded-full border-2 border-slate-900 opacity-90 flex items-center justify-center group-hover:opacity-100 transition-opacity">
                    <div className="w-1 h-1 bg-slate-900 rounded-full"></div>
                    <div className="absolute w-6 h-0.5 bg-slate-900 rotate-45 opacity-20 group-hover:rotate-90 transition-transform duration-700"></div>
                    <div className="absolute w-6 h-0.5 bg-slate-900 -rotate-45 opacity-20 group-hover:-rotate-90 transition-transform duration-700"></div>
                  </div>
               </div>
            </div>
            ...
            <a href="#home" className="flex flex-col cursor-pointer group">
              <span className="font-extrabold text-xl text-slate-900 leading-none tracking-tight group-hover:text-teal-700 transition-colors font-heading">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Button variant="primary" size="sm" className="shadow-lg shadow-teal-900/10 font-bold tracking-wide">Official Login</Button>
          </div>
      ...
      {/* Mobile Menu */}
      {isMobileMenuOpen && (
        <div className="md:hidden bg-white border-t border-slate-100 shadow-xl absolute w-full left-0 animate-fade-in z-40">
          <div className="flex flex-col p-4 gap-2">
            ...
            <Button variant="primary" className="w-full justify-center">Official Login</Button>
          </div>
        </div>
      )}
    </header>
